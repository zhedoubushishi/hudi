...
public class HoodieTableMetaClient implements Serializable {
  ...
  public static HoodieTableMetaClient initTableAndGetMetaClient(Configuration hadoopConf, String basePath,
    ...
    if (!archiveLogPropVal.equals(HoodieTableConfig.HOODIE_ARCHIVELOG_FOLDER_PROP.defaultValue())) {
  ...
  public static class PropertyBuilder {
    ...
    public PropertyBuilder fromProperties(Properties properties) {
      ...
      if (hoodieConfig.contains(HoodieTableConfig.HOODIE_TABLE_PARTITION_COLUMNS_PROP)) {
        setPartitionColumns(hoodieConfig.getString(HoodieTableConfig.HOODIE_TABLE_PARTITION_COLUMNS_PROP));
      }
      return this;
    }
