...
class TestDataSourceForBootstrap {
  ...
  @Test def testMetadataBootstrapCOWNonPartitioned(): Unit = {
    ...
    verifyIncrementalPullResult(commitInstantTime1, commitInstantTime2, isPartitioned = false, isHiveStylePartitioned = false)
  }
  ...
  @Test def testMetadataBootstrapCOWHiveStylePartitioned(): Unit = {
    ...
    verifyIncrementalPullResult(commitInstantTime1, commitInstantTime2, isPartitioned = true, isHiveStylePartitioned = true)
  }
  ...
  @Test def testMetadataBootstrapCOWPartitioned(): Unit = {
    ...
    verifyIncrementalPullResult(commitInstantTime1, commitInstantTime3, isPartitioned = true, isHiveStylePartitioned = false)
  }
  ...
  @Test def testFullBootstrapCOWPartitioned(): Unit = {
    ...
    verifyIncrementalPullResult(commitInstantTime1, commitInstantTime2, isPartitioned = true, isHiveStylePartitioned = false)
  }
  ...
  def updateBasedOnWrittenTable(hoodieROViewDF1: DataFrame) = {
    val updateDf1 = hoodieROViewDF1.filter(col("_row_key") === "trip_0").withColumn("driver", lit("driver_update"))
    updateDf1.write
      .format("hudi")
      .options(commonOpts)
  ...
  def verifyIncrementalPullResult(commitInstantTime1: String, commitInstantTime2: String, isPartitioned: Boolean, isHiveStylePartitioned: Boolean): Unit = {
