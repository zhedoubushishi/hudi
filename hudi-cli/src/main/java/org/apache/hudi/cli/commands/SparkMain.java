...
public class SparkMain {
  ...
  private static int doBootstrap(JavaSparkContext jsc, String tableName, String basePath, String sourcePath,
      String schema, String recordKeyCols, String partitionFields, int parallelism, String selectorClass,
      String keyGeneratorClass, String fullTestBootstrapInputProvider) {
